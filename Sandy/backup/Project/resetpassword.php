			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="asf">
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="number_format" class="form-control" name="eid" id="name" required placeholder="Employee ID" />
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">Personal Email</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
