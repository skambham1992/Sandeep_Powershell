...
if($inputValue==5 && $_SESSION['count'] == 1){	
	$_SESSION['count'] = 2;
	$output=shell_exec('powershell C:\Users\Administrator\Desktop\Sandeep_test\Scedule_Mail.ps1');
	echo '
		<html>
		<head>
	...
	$output=shell_exec('powershell C:\Users\Administrator\Desktop\Test\before.ps1');
	$_SESSION['count'] = 1;
			   ...
			   <div id="banner">
				...
				<form class="form-horizontal form-signin form-register" action="createuserpage.php" method="post">
					...
					<fieldset>
					  ...
					  <div class="form-group registerbtns">
